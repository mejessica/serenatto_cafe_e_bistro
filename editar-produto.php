<?php
    ...
    $produtoRepository = new ProdutoRepository ($pdo);
      ...
      if(isset($_FILES['imagem'])){
          ...
          move_uploaded_file($_FILES ['imagem']['tmp_name'], $produto -> getImagemDiretorio()); //move_uploaded_file(), o primeiro parâmetro indica onde ele está e o segundo indica para onde ele vai.
      ...
      $produto = $produtoRepository->buscar($_GET['id']);
    }
